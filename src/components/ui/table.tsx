...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div className="cds--data-table-container wfm-carbon-table-container">
...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cn("wfm-carbon-table__footer", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <caption ref={ref} className={cn("wfm-carbon-table__caption", className)} {...props} />
));
